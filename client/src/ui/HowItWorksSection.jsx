...
// 	<FadeIn>
// 		<div
// 			className={`p-6 bg-white/60 backdrop-blur-xl hover:bg-white/80 hover:scale-[1.03] cursor-pointer rounded-2xl text-[#1e1633] shadow-md hover:shadow-violet-300/60 border border-violet-100 transition duration-300 w-full`}
// 		>
// 			<h3
// 				className="text-xl font-semibold mb-2 text-violet-800"
// 				style={{ fontFamily: "P22Mackinac, serif" }}
// 			>
// 				{step.title}
// 			</h3>
// 			<p className="text-slate-600 inter text-base leading-relaxed">
// 				{step.description}
// 			</p>
// 		</div>
// 	</FadeIn>
