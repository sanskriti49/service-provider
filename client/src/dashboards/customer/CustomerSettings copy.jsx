...
const CustomerSettings = () => {
	...
	// ✅ FIXED INITIALIZER: Address fallback isolated from broad location properties
	...
	const updateProfile = async (dataToUpdate, specificLoadingSet) => {
		try {
			...
			// ✅ FIXED DATA STATE SYNC MAPPINGS
	...
	const handleCurrentLocation = () => {
		...
		// ✅ FIXED LOADING FOCUS POINTER: Points to location hook indicator now
		...
		navigator.geolocation.getCurrentPosition(
			async (position) => {
				...
				try {
					...
					// Dig out the clean location descriptor text safely
					const cityOrTown =
						data.address?.city ||
						data.address?.town ||
