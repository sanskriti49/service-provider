...
762 -785 768 -38 14 -85 12 -122 -4z"
								...
								<div className="absolute top-full left-0 mt-2 hidden group-hover:flex flex-col bg-white shadow-lg rounded-lg p-6 z-[100]">
									<Link to="/services/design" className="hover:text-violet-600">
										Design
									</Link>
									<Link
								...
								<span className="absolute inset-x-5 h-px bg-gradient-to-r from-violet-500/0 from-10% via-violet-400 to-violet-500/0 to-90% transition duration-300 -bottom-0.5 opacity-0 scale-x-0 group-hover:opacity-200 group-hover:scale-x-200"></span>

								<span className="group  overflow-hidden absolute inset-0 transition origin-bottom duration-300 opacity-0 scale-0 group-hover:opacity-100 group-hover:scale-100">
									<span className="absolute  inset-x-3 -bottom-2 h-full bg-gradient-to-t from-violet-500/20 to-transparent blur rounded-t-full"></span>
								</span>
							</Link>
							...
							<Link
								to="/"
								className="hover:text-violet-600  transition-colors duration-300  group relative pr-3 py-2.5 cursor-pointer *:group ease-out active:scale-95 hover:scale-105"
							>
								Work With Us
								<span className="absolute inset-x-1 h-px bg-gradient-to-r from-violet-500/0 from-10% via-violet-400 to-violet-500/0 to-90% transition duration-300 -bottom-0.5 opacity-0 scale-x-0 group-hover:opacity-100 group-hover:scale-x-100"></span>
								<span className="overflow-hidden absolute inset-0 transition origin-bottom duration-300 opacity-0 scale-0 group-hover:opacity-100 group-hover:scale-100">
