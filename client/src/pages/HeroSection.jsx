		...
		>
			...
			<div className="relative z-10 max-w-3xl mx-auto px-4 sm:px-6">
				<div className="flex flex-col items-center text-center bricolage-grotesque">
					<p className="hero-badge font-semibold text-violet-900 text-xs sm:text-sm tracking-widest uppercase mb-3 backdrop-blur-md px-4 py-1.5 shadow-xs">
					...
					<p className="hero-sub text-[#281950]/90 text-base sm:text-lg md:text-xl mt-2 mb-8 max-w-xl mx-auto leading-relaxed font-medium bg-white/40 backdrop-blur-xs px-4 py-1.5 rounded-2xl border border-white/40">
						...
						<div className="flex flex-wrap items-center justify-center gap-2 mt-6">
							...
							{popularSearches.map((term) => (
								<Link
									...
									className="hero-pill px-3.5 py-1.5 text-xs sm:text-sm font-semibold text-violet-900 bg-white/80 border border-violet-200/80 rounded-full
