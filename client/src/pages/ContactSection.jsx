...
export default function ContactSection() {
	...
	useEffect(() => {
		emailjs.init("VSuB8cLKQ6u5BQFuj");
	}, []);
	...
	const sendEmail = (e) => {
		...
		toast.promise(
				...
				}),
			{
				...
				className:
					"bricolage-grotesque rounded-2xl p-4 shadow-xl border border-white/40 bg-white/90 backdrop-blur-md text-base font-semibold text-slate-800",
				descriptionClassName: "text-slate-500 font-normal text-sm mt-0.5",
			},
		);
	};
